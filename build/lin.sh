...
./configure --host=${CHOST} --prefix=${TARGET} --disable-shared --enable-static --disable-dependency-tracking
make install
...
curl -Os https://raw.githubusercontent.com/avishnyak/sharp-libvips/master/THIRD-PARTY-NOTICES.md
